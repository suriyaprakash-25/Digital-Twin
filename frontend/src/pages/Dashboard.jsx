                                    ...
                                    <div key={v.id} className="flex flex-col p-5 bg-white rounded-2xl border border-slate-100 hover:border-teal-200 hover:shadow-md transition-all group">
                                        <div className="flex justify-between items-center mb-3">
                                            ...
                                            <div className="text-right">
                                                <p className={`font-metric text-metric-lg ${scoreColor}`}>{h.healthScore}</p>
    ...
    return (
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-slate-100 relative overflow-hidden hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-lg group cursor-default">
            ...
            <div>
                ...
                <p className="font-metric text-metric-hero text-slate-900 group-hover:text-teal-600 transition-colors">{value}</p>
